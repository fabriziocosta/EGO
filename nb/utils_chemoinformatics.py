...
def draw_graphs(graphs, titles=None, num=None, n_graphs_per_line=7):
    ...
    try:
        ...
        args = dict(layout='kk', colormap=colormap, vmin=0, vmax=1, vertex_size=80, edge_label=None, vertex_color_dict=colors, vertex_color='-label-', vertex_label=None,  ignore_for_layout='nesting')
